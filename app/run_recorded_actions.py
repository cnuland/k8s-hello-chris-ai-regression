...
def run_recorded_actions_on_emulator_and_save_video(sess_id, instance_id, run_index):
    ...
    env_config = {
            ...
            'action_freq': 9, 'init_state': 'ignored/dd.gb.state', 'max_steps': max_steps, #ep_length, 
            'print_rewards': False, 'save_video': True, 'fast_video': False, 'session_path': sess_path,
            'gb_path': '../ignored/dd.gb', 'debug': False, 'sim_frame_dist': 2_000_000.0, 'instance_id': f'{instance_id}_recorded'
    }
    env = DDEnv(env_config)
